...
public class Normal_Ending : MonoBehaviour
{
    ...
    public void Ending_Cradit()//내가 추가한 거. 트루 엔딩을 위해 다음 씬으로 ㄱㄱ
    {
        //fadeOutPanel.SetActive(true);
        fadeInPanel.SetActive(true);

        StartCoroutine(Ending_Cra());//대사 후 컨트롤러 나올 시간을 벌기 위해 만든 거

        IEnumerator Ending_Cra()//대사 후 컨트롤러 생성위해 만든 함수
        {
